...
[[retrocausality|Retrocausal]] interpretations of quantum mechanics offer a resolution. The fundamental equations of quantum mechanics are time-symmetric—they work equally well run forward or backward. Physicists like Huw Price and John Cramer argue that if physics is time-symmetric and causal, some influences must run backward in time.
...
The discussion so far focuses on proximal choice—the immediate decision to act. But [[prospective-memory|prospective memory]] introduces a crucial distinction: most voluntary action involves *distal* intentions formed earlier and maintained over time.
...
Research shows that [[prospective-memory#Episodic Future Thinking|episodic future thinking]] (EFT)—vividly imagining future scenarios—causally influences present decisions:
