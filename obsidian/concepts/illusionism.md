...
modified: 2026-01-14
human_modified: null
ai_modified: 2026-01-17T04:20:00+00:00
draft: false
topics:
...
Keith Frankish and Daniel Dennett, illusionism's leading defenders, hold that we *seem* to have experiences with special qualitative properties ([[qualia]]), but this seeming is itself a misrepresentation. There are no phenomenal properties, only representations *as if* there were.
...
Graziano's [[attention-schema-theory|Attention Schema Theory]] (AST) provides the most developed neuroscientific implementation of illusionism. Where philosophical illusionists like Frankish and Dennett argue that introspection misrepresents experience, AST explains *how* the brain generates this misrepresentation.
...
Whether this response succeeds remains contested. The challenge is explaining how *seeming* works without invoking something phenomenal.
...
Recent work has focused on whether illusionism can be distinguished from ordinary [[materialism]] in practice, and on explaining the "hardest aspect" of the illusion problem: why the illusion resists dissolution.
...
- Graziano, M. S. A. (2024). "Illusionism Big and Small."
