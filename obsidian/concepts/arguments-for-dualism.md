...
Hasker's "emergent dualism" offers a nuanced position: the soul is generated by brain function but is itself non-physical—an emergent substance, not Cartesian. The soul has spatial location and depends on the brain for its existence while remaining ontologically distinct from it.
...
Franz Brentano claimed intentionality is "the mark of the mental"—the feature distinguishing minds from matter. Decades of attempts to reduce intentionality to physical relations (causal, informational, teleological) have failed. The site's intentionality article details these failures.
...
Several responses bear on this:

**Explanatory adequacy trumps parsimony**: A theory that explains the phenomena with slightly more ontology is preferable to one that explains less with less. Physicalism's apparent parsimony comes from ignoring consciousness or explaining it away. A "simpler" theory that doesn't account for the data isn't superior—it's inadequate.
...
A fair assessment of dualism must engage the strongest objections. Five major challenges merit attention. For comprehensive treatment of each objection with detailed responses, see [[objections-to-interactionism]]. Below is a summary.
...
**[[tenets#^occam|Occam's Razor Has Limits]]**: The parsimony objection assumes we have adequate concepts to judge simplicity. But if consciousness introduces genuinely novel features—features physics cannot describe—then materialist "simplicity" is achieved by ignoring the evidence.
...
**[[tenets#^no-many-worlds|No Many Worlds]]**: The unity and personal identity arguments presuppose a single subject. Many-worlds fragments this: in branching universes, "you" become many, and personal identity dissolves. The dualist picture requires definite outcomes and definite subjects.
