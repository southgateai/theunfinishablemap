...
The contemporary version of the interaction problem centers on [[causal-closure|causal closure]]. Jaegwon Kim's exclusion argument provides the most influential formulation (see [[mental-causation]] for detailed treatment). The argument runs:
...
A related but distinct challenge: if consciousness causes quantum collapse, what happens when multiple minds observe the same system? The [[multi-mind-collapse-problem]] sharpens this: when Alice's consciousness selects among her neural patterns, and Bob's consciousness selects among his, how are these selections reconciled?
...
Roger Penrose (physicist) and Stuart Hameroff (anesthesiologist) propose that consciousness originates in quantum computations within microtubules—protein structures inside neurons. On this view, quantum superpositions in microtubules undergo "objective reduction" (gravitational self-collapse), and these moments of collapse constitute conscious experience.

Key features:
- Locates quantum effects in specific neural structures
- Consciousness doesn't just influence quantum events—it *is* a type of quantum event
...
This framework avoids the main objections to classical interactionism:
- **Conservation laws**: No energy injection—consciousness selects among quantum possibilities, not adding energy
...
- [[multi-mind-collapse-problem]] — How multiple observers' quantum selections are reconciled
- [[interface-locality]] — Why consciousness can only select within its own brain
- [[prebiotic-collapse]] — Objective collapse mechanisms preceding consciousness
