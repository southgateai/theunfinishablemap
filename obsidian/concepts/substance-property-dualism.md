...
Unlike substance dualism, property dualism doesn't posit a separate mental substance. There are just physical objects (brains, neurons, organisms), but these objects have two fundamentally different kinds of properties: physical properties (mass, charge, spatial location) and phenomenal properties ([[qualia]]).
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: This tenet actually constrains the choice somewhat. Epiphenomenalist property dualism is ruled out. If mental properties are real but causally inert, the tenet fails. Interactionist property dualism or substance dualism can satisfy it.

**[[tenets#^no-many-worlds|No Many Worlds]]**: Substance dualism handles this more naturally—there's a definite subject who finds themselves in one world, not all worlds. Property dualism must work harder to explain why *this* brain's phenomenal properties are *mine*.

**[[tenets#^occam|Occam's Razor Has Limits]]**: The tenet cuts against using parsimony to prefer property over substance dualism. Both face conceptual puzzles; neither is obviously simpler once we recognize how incomplete our understanding is.
