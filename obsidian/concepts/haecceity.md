...
The site's [[tenets#^dualism|Dualism]] tenet treats consciousness as irreducible to physical processes. This commitment has haecceitistic implications.
...
The [[tenets#^no-many-worlds|No Many Worlds]] tenet explicitly invokes indexical identity. The objection to many-worlds isn't merely ontological (too many universes) or probabilistic (the Born rule problem). It's fundamentally about identity:
...
The [[many-worlds|probability problem]] for many-worlds connects to haecceity. In many-worlds, after a spin measurement, there are branches with spin-up and branches with spin-down. All exist equally. Why do we observe Born-rule statistics?
