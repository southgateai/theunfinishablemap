...
modified: 2026-01-17
human_modified: null
ai_modified: 2026-01-17T08:00:00+00:00
draft: false
topics:
...
Implicit memory matters for the site's framework because it reveals consciousness as an *interface* that can delegate to procedural systems. Endel Tulving associated implicit memory with *anoetic consciousness*: awareness without self-knowledge, action without reflection. Crucially, when consciousness forcibly re-engages with automatized skills—when you attend to your typing or think about your footwork—performance typically *degrades*. This "choking under pressure" phenomenon provides direct evidence for [[mental-causation|bidirectional interaction]]: consciousness causally affects procedural execution, sometimes disruptively. If consciousness were epiphenomenal, attending to skills couldn't interfere with them.
...
**Autonoetic consciousness** ("self-knowing") accompanies [[autonoetic-consciousness|episodic memory]]. You don't merely know facts about your past; you mentally travel back and re-experience events, phenomenally present as both current rememberer and past protagonist.
...
The Dreyfus model of skill acquisition charts how consciousness relates to procedural memory across development, describing a progression from rule-following to intuition that illuminates the [[attention-as-interface|interface hypothesis]].

### Five Stages

**Novice**: Follows explicit rules without situational context. Learning to drive, you consciously follow "check mirrors, signal, check blind spot" sequences. Every action requires [[mental-effort|deliberate attention]].

**Advanced beginner**: Recognises situational patterns through experience. You notice the feel of "too fast for this curve" without calculating speeds.

**Competent**: Chooses among rules and perspectives, takes responsibility for outcomes. Conscious planning and emotional investment emerge.

**Proficient**: Sees situations holistically, knows intuitively what to do, but still thinks analytically about how. The "what" becomes automatic; the "how" requires attention.

**Expert**: Acts fluidly without deliberation. Experts "do what normally works" without reflective decision-making. Chess masters don't calculate positions—they see good moves.

### The Transition to Automaticity

The key phenomenological transition occurs between competent and expert performance. Initially, skills require conscious attention at every step. Gradually, consciousness *withdraws* from execution details while retaining oversight capacity. The expert doesn't lose awareness—they enter the anoetic mode where action flows without self-observation.

This withdrawal is not elimination. Consciousness delegates to procedural systems but retains the ability to re-engage. The expert driver notices the unusual road surface and shifts attention; the expert typist catches the error and consciously corrects. The interface can re-engage—and this re-engagement has consequences, as the choking phenomenon reveals.
...
Choking provides direct evidence for [[mental-causation|consciousness causally affecting]] brain processes. Consider the causal chain:
...
A deeper question: does implicit learning occur without *any* form of awareness? Research on priming, conditioning, and subliminal perception suggests learning can occur without explicit awareness of what was learned.

### The Evidence

- **Priming**: Processing a stimulus facilitates processing of related stimuli, even when the prime was presented below awareness thresholds
- **Conditioning**: Emotional responses can develop to stimuli never consciously perceived
- **Blindsight**: Brain-damaged patients navigate obstacles they report not seeing
...
The [[attention-as-interface|attention interface]] explains why consciousness can delegate: once skills are calibrated, the low-bandwidth interface need not continuously engage. Procedural systems run on trained patterns; consciousness intervenes only when selection among alternatives is required.

### Bidirectional Interaction
Choking provides the clearest evidence. Conscious attention to automatized skills disrupts execution. This causal interference—consciousness affecting procedural processing—couldn't occur if consciousness were epiphenomenal.

### No Many Worlds
Skill execution involves selecting among action possibilities. If [[many-worlds|all possibilities actualised]], skilled performance couldn't be coherent—every possible action would occur. The single actualised trajectory of expert performance requires genuine selection.

### Occam's Razor Has Limits
Eliminating consciousness from accounts of skill acquisition can't explain choking. The simplest account that covers the phenomena requires consciousness as a causal factor that can interfere with procedural execution—not just accompany it.
