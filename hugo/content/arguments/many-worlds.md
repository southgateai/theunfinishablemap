...
When does branching occur? Standard many-worlds says: when decoherence makes interference undetectable. But [decoherence](/concepts/decoherence/) is continuous and basis-dependent. The same physical situation can be described in different bases; which one corresponds to "real" branches?
...
**Premise 2**: The [hard problem](/topics/hard-problem-of-consciousness/)—why there is something it is like to be a physical system—remains.
...
**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: Consciousness selects among quantum outcomes. But in many-worlds there is nothing to select; all outcomes occur.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: Consciousness biases probabilities at indeterminacies. But many-worlds eliminates indeterminacy—deterministic branching replaces probabilistic collapse.
