...
The April 2025 COGITATE study represents a more rigorous test: a seven-year adversarial collaboration where IIT and [GNWT](/concepts/global-workspace-theory/) proponents jointly designed experiments to test their theories. Both camps agreed in advance what results would challenge their respective theories.
...
IIT takes consciousness seriously as fundamental—not an illusion, not an epiphenomenon, not "mere" information processing. The axioms begin with the undeniable fact of experience. This resonates with the [Dualism](/tenets/#dualism) tenet's insistence that consciousness is not reducible to physical processes.

IIT's willingness to accept panpsychism also aligns with the [Occam's Razor Has Limits](/tenets/#occams-limits) tenet. Tononi doesn't reject panpsychism just because it seems strange. The theory follows its logic wherever it leads, even to counterintuitive conclusions.
