...
The Dreyfus model of skill acquisition charts how consciousness relates to procedural memory across development, describing a progression from rule-following to intuition that illuminates the [interface hypothesis](/concepts/attention-as-interface/).

### Five Stages

**Novice**: Follows explicit rules without situational context. Learning to drive, you consciously follow "check mirrors, signal, check blind spot" sequences. Every action requires [deliberate attention](/concepts/mental-effort/).
...
The [attention interface](/concepts/attention-as-interface/) explains why consciousness can delegate: once skills are calibrated, the low-bandwidth interface need not continuously engage. Procedural systems run on trained patterns; consciousness intervenes only when selection among alternatives is required.
...
### No Many Worlds
Skill execution involves selecting among action possibilities. If [all possibilities actualised](/arguments/many-worlds/), skilled performance couldn't be coherent—every possible action would occur. The single actualised trajectory of expert performance requires genuine selection.
...
- [mental-effort](/concepts/mental-effort/) - The phenomenology of effortful attention and its relation to skill automaticity
